...
Different from the flexible job shop problem this time the DE population update seems to work better.
The NSGA-II population update improves faster, but finally the DE population update delivers better
results.  
