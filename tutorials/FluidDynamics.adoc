...
There is nothing magic behind the mixed integer support, it a minor - but quite effective - modification:
...
Here https://www.thevisualroom.com/33_machine_learning/optimiserTestProblemSuite/PitzDailyAlma.html[PitzDaily] is a nice visualization of the problem. It is chosen as an https://www.youtube.com/watch?v=f6U8fdNqsec[OpenFOAM] tutorial, because
...
- We couldn't prove the superiority of surrogate based methods even for for complex mixed integer CFD 
