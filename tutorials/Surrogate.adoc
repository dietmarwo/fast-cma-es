...
On the other hand: If you for instance really want to produce the three car models using a specific combined
mass of 2.625, the number of common part thicknesses shown for the best competition results is
...
The following optimizer configuration was used to produce the `Hypervolume = 0.5133` reference solution below.
