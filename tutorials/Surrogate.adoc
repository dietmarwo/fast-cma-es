...
using DE update (NSGA update needs more). The result The result obtained after 500000 generations
(about 2.5 hours per optimization run on the AMD5959x) is not sufficient to "solve" the car design problem, 
...
the result is an improvement. Because of paralellizaiton and since we call the objective function 
