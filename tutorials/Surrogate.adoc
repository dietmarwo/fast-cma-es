...
using DE update (NSGA update needs more). The result is not sufficient to "solve" the
car design problem, we miss about 15-20 common part thicknesses.  
 
image::NSGAII768.500k.png[]

These results a quite far away from what we saw above what fcmaes MODE (modecpp) can do using only 1600 seconds using DE update. 
