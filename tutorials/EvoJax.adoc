...
Additionally a {cpp} implementation of http://mediatum.ub.tum.de/doc/1099128/631352.pdf[PGPE] was added to fcmaes derived from its JAX-based https://github.com/google/evojax/blob/main/evojax/algo/pgpe.py[EvoJax implementation]. Performance difference between these versions are very similar as for CR-FM-NES.
