...
image::brandi10.223mode.png[]

The optimization needed  "TODO" , `retry_modecpp` was called using 

[source,python]
----
xs, front = retry_modecpp(fit, retry_num=640, popsize = 500, max_eval = 16000000, workers=16)
----
