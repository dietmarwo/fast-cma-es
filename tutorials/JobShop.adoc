...
- Applies continuous optimization and https://numba.pydata.org/[numba] to solve 
the Flexible job shop problem (FJSP). 
- On modern many core CPUs dedicated algorithms often can be replaced by generic
optimization still delivering good results. 
- Advantages are:
* Ease of implementation.
* Can easily be adapted to additional constraints / objectives or noise. 
- This flexibility is shown by solving a problem variant optimizing asteroid harvesting. 
