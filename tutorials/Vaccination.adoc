...
budged and then over the handwashing campaign spending. We are interested 
...
improved paralellization-scaling we can compute a much bigger solution this way. Note that this
