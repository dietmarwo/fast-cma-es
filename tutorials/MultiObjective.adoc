...
image::all_ret.fonseca(20)__random.png[] 

- Poloni function random search, dim = 20, 1024 retries, 50000 evaluations:

image::all_ret.poloni(20)__random.png[] 
...
image::all_ret.zdt1(20)__decma.png[]

- Pareto front:

image::front_ret.zdt1(20)__decma.png[]
