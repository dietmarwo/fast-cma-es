...
overhead shrinks which means we get better scaling: The execution of all optimization needs less time,
...
- SPSA and CR-FM-NES need the same time.
...
- Optimization results for the 16 runs differ slightly, CR-FM-NES has higher standard deviation and best energy found, SPSA has a
