...
In https://doi.org/10.1016/j.asoc.2020.106451[G-CLDE paper] and http://www.midaco-solver.com/data/pub/PDPTA20_Messenger.pdf[MXHCP paper] show actual results of state of the art algorithms for the GTOP benchmarks. Usually mean / sdev and best results are shown for a number of
