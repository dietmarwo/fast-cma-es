...
For the best sequence we already got an optimal solution, otherwise we could continue further evaluating the best ones. 
...
worst kind scenario for the MINLP approach.  
