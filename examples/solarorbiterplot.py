...
def plot_solar_orbiter():
    ...
    #fval = 1.62
    seq = [earth, earth, venus, venus, venus, venus, venus, earth, venus]
    pop_champion_x = [7942.026817575027, 663.1973866547687, 110.83717257810456, 410.6397021072476, 672.0582026824557, 674.0833480525613, 410.54698432833516, 77.20546199801032, 203.69854777932733, -5.555085164691073, 1.0578321216164421]
...
#     pop_champion_x = [7309.955686504108, 242.00305306309562, 403.31913927172866, 80.568048104212, 376.3052464119222, 672.2642026142728, 672.2698205678452, 672.2914624962455, 410.3229994185495, 0.9756176647367582, 1.0578321217798627]
   ...
   #fval = 1.94
#    seq = [earth, earth, venus, venus, earth, earth, venus, venus, venus]
#    pop_champion_x = [7377.946182632484, 656.2166898534144, 109.612685881796, 410.19890846764264, 72.80629265326039, 588.9327245019557, 76.16349432566007, 657.1594783265762, 657.1683032327055, 0.3696876823897329, 1.057832121612924]
