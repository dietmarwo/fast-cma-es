...
https://github.com/dietmarwo/fast-cma-es/blob/master/fcmaes_documentation.html[algorithms].

fcmaes is a general-purpose library for modern gradient-free optimization. It is designed for real-world problems, including multi-objective and constrained optimization. The main algorithms are available in both Python and C++. They support parallel fitness evaluation as well as parallel retry strategies.

There are many practical https://github.com/dietmarwo/fast-cma-es/blob/master/tutorials/Tutorials.adoc[tutorials] and https://github.com/dietmarwo/fast-cma-es/blob/master/examples_documentation.html[examples] that show how to use fcmaes in detail.
