...
- https://github.com/dietmarwo/fast-cma-es/blob/master/tutorials/TopTrumps.adoc[gbea TopTrumps Benchmark] TopTrumps game optimization benchmark results. 
- https://github.com/dietmarwo/fast-cma-es/blob/master/tutorials/NSGAII.adoc[MO-DE-NSGAII] MO-DE, a new multi objective algorithm. 
