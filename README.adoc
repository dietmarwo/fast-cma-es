...
https://dietmarwo.github.io/fast-cma-es/fcmaes_documentation.html.html[algorithms].
...
There are many practical https://github.com/dietmarwo/fast-cma-es/blob/master/tutorials/Tutorials.adoc[tutorials] and https://dietmarwo.github.io/fast-cma-es/examples_documentation.html[examples] that show how to use fcmaes in detail.
