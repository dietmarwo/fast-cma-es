...
* Recommended Python environment: https://github.com/conda-forge/miniforge[Miniforge] . At least Python 3.7 is required.
...
* Recommended Python environment: https://github.com/conda-forge/miniforge[Miniforge] .
