...
On an 16 core AMD 3950x fcmaes with parallel retry performs > 650000 messenger_full evaluations per second using the `DE->CMA` sequence, and > 900000 evaluations per second using only CMA-ES. 
