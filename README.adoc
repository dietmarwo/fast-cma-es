...
- New implementation of CVT-map-elites including a CMA-ES emitter. 
- New "diversifier" meta algorithm utilizing CVT-map-elites archives. 
...
- sklearn: https://github.com/scikit-learn/scikit-learn (for CVT-Map-Elites)
