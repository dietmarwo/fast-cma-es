...
Single objective PAGMO problems can be wrapped using `fcmaes.optimizer.single_objective`, `pg.unconstrain` is used to convert
the time limit into a penalty added to the objective function value.
