...
whether the final result below is a good solution. But `fitness = 7.4338` should be a challenge for other optimizing algorithms for the unconstrained Tandem problem for sequence 6. 
