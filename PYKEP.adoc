...
==== Juice
https://github.com/esa/pykep/blob/master/pykep/trajopt/gym/_juice.py[Juice] represents rendezvous mission to Jupiter modelled as an MGA-1DSM transfer. The selected fly-by sequence, E-EVEME-J, and other parameters are inspired to the ESA Juice mission. A launcher model is included, namely an Ariane5
